...
\draw[ultra thick, scale=0.5, domain=-9:9,smooth,variable=\x, blue] plot ({\x},{-1/2*\x-2}) node[below, black, scale=2] {F};
\draw [draw=blue, fill=blue, thick] (-4.5,1.25) circle (4.0pt);
\draw [draw=blue, fill=blue, thick] (4.5,-3.25) circle (4.0pt);

\draw[ultra thick, scale=0.5, domain=-2.25:2.25,smooth,variable=\x, blue] plot ({\x},{-\x*\x-4}) node[right, black, scale=2] {G};
\draw [draw=blue, fill=blue, thick] (-1.15,-4.5) circle (4.0pt);
\draw [draw=blue, fill=white, thick] (1.15,-4.5) circle (4.0pt);

\draw[ultra thick, scale=0.5, domain=-2.25:2.25,smooth,variable=\x, blue] plot ({\x*\x+3}, {\x}) node[right, black, scale=2] {H};
